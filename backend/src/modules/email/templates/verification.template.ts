...
<head>
  ...
  <title>Verify Your Email — CPNudge</title>
</head>
          ...
          <tr>
            <td style="padding: 36px 32px 24px;">
              ...
              <p style="margin: 0 0 24px; color: #51545e; font-size: 15px; line-height: 1.6;">
                Hi ${firstName},<br /><br />
                Thanks for signing up for CPNudge! Please confirm your email address by clicking the button below.
              </p>
              ...
              <table role="presentation" cellpadding="0" cellspacing="0" style="margin: 0 auto 24px;">
                <tr>
                  <td align="center" style="border-radius: 6px; background-color: #4f46e5;">
                    <a href="${verificationUrl}" target="_blank" style="display: inline-block; padding: 14px 32px; color: #ffffff; font-size: 15px; font-weight: 600; text-decoration: none; border-radius: 6px;">
                ...
                <tr>
                  <td style="padding: 12px 16px; background-color: #fff8e1; border-left: 4px solid #f59e0b; border-radius: 4px;">
                    <p style="margin: 0; color: #92400e; font-size: 13px; line-height: 1.5;">
                      ⏳ This link expires in <strong>${expiresInMinutes} minutes</strong>. After that you'll need to request a new one.
                    </p>
                  </td>
                </tr>
              </table>

              <p style="margin: 0; color: #51545e; font-size: 13px; line-height: 1.5;">
                If you didn't create an account with CPNudge, you can safely ignore this email.
              </p>
            </td>
          </tr>
